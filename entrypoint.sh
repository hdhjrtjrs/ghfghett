...
UUID=${UUID:-'e1b94baa-8bc5-4f00-8cd8-e2d371bc4545'}
VMESS_WSPATH=${VMESS_WSPATH:-'/e1b94baa-8bc5-4f00-8cd8-e2d371bc4545-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/e1b94baa-8bc5-4f00-8cd8-e2d371bc4545-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/e1b94baa-8bc5-4f00-8cd8-e2d371bc4545-trojan'}
SS_WSPATH=${SS_WSPATH:-'/e1b94baa-8bc5-4f00-8cd8-e2d371bc4545-shadowsocks'}
